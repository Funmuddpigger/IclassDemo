...
public interface DisposeClassService {
    //随机分配
    String randomClass(String class_id, int user_id, String user_name, Timestamp apply_goTime, Timestamp apply_backTime, int number_people, String class_note, String class_property,int howWeek,String severalWeeks);
    //判断是否有存在相交记录
