...
public class ClassAllController {
    ...
    public Result selectbyclassfirst(HttpServletRequest request,@RequestParam(value = "page",required = true,defaultValue = "0") Integer page,
                                     @RequestParam(value = "pagesize",required = true,defaultValue = "20") Integer pagesize){
    ...
    @RequestMapping(value = "/select/deleteClassByNam" , method = {RequestMethod.GET,RequestMethod.POST})
