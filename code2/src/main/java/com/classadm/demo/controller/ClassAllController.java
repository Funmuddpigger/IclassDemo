...
public class ClassAllController {
    ...
    @RequestMapping(value = "/select/getall" ,method = {RequestMethod.GET,RequestMethod.POST})
    public Result selectall(){
        List<ClassAll> classAlls = classAllService.getAll();
        Result getallresult = Result.success(classAlls);
        return getallresult;
    }
