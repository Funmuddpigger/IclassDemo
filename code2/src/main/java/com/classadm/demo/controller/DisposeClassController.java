...
public class DisposeClassController {
    ...
    /*
    public Result distributionClass(String class_id, int user_id, String user_name, Date class_goTime, Date class_backTime, String class_note, int number_people) throws JSONException {
           String result = disposeClassService.distributionClass(class_id,user_id,user_name,class_goTime,class_backTime,class_note,number_people);
        if(result.equals("406")) {
           return Result.authorizationfail("分配失败");
       }
       else {
